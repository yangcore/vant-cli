...
async function compileCss(source,filePath) {
    // const config = await postcss_load_config_1.default({},  require(constant_1.POSTCSS_CONFIG_FILE)(filePath));
    const config = require(constant_1.POSTCSS_CONFIG_FILE)(filePath)
